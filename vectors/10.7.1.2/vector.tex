...
\thiswatermark{\centering \put(0,-105.0){\includegraphics[scale=0.15]{/sdcard/IITH/vectors/10.7.1.2/figs/logo.png}} }
\title{\mytitle}
\title{
Assignment - Vector
}
...
\begin{figure}[!ht]
    \centering
\includegraphics[width=\columnwidth]{/sdcard/IITH/vectors/10.7.1.2/figs/vec.pdf}
\caption{}
\label{fig:vec}
\end{figure}
