...
\thiswatermark{\centering \put(0,-105.0){\includegraphics[scale=0.15]{/sdcard/IITH/vector/fig/logo2.png}} }
\title{\mytitle}
\title{
Assignment - Vector
}
...
\begin{figure}[!h]
    \centering
\includegraphics[width=\columnwidth]{/sdcard/IITH/vector/fig/vec.pdf}
