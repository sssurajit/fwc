...
\thiswatermark{\centering \put(0,-105.0){\includegraphics[scale=0.15]{/home/jeet/iith/vector/vector-3/figs/logo.png}} }
\title{\mytitle}
\title{
Assignment - Vector-3
}
...
\begin{figure}[!ht]
    \centering
\includegraphics[width=\columnwidth]{/home/jeet/iith/vector/vector-3/figs/vec.pdf}
\caption{}
\label{fig:vec}
\end{figure}
