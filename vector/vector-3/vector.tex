...
\begin{figure}[!ht]
    \centering
\includegraphics[width=\columnwidth]{/sdcard/IITH/vector/vector-3/figs/vec-1.pdf}
\caption{}
\label{fig:vec}
\end{figure}
\item
\begin{figure}[!ht]
    \centering
\includegraphics[width=\columnwidth]{/sdcard/IITH/vector/vector-3/figs/vec-2.pdf}
\caption{}
\label{fig:vec}
\end{figure}
\end{enumerate}
